...
[
  ...
  },
  {
    ...
    "file": ".planning/REQUIREMENTS.md",
    "line": null,
    "description": "O-04 recommended action #1 is unassigned: MAP-02 still carries the unqualified parenthetical '781 sources / 12.66 MB / 21 ms', which reads as a Caido measurement and is not one (standalone quickjs-ng 0.16.1, STACK.md:546). Plan 07-01 recorded the provenance in map-bytes.json's verdict and gated it, but did not amend or strike the requirement text.",
    "status": "open",
    "reason": "",
  ...
  },
  {
    ...
    "kind": "deviation",
    "phase": "07",
    "file": "packages/backend/src/store/sources.spec.ts",
    "line": null,
    "description": "07-11: the two-bundle disambiguation cases run on a spec-local re-keyed source_sightings, because the shipped v:8 primary key makes the pair unrepresentable. Delete widerKeyFixture() and rebuild on the real table once plan 07-12 widens the key.",
    "status": "open",
    "reason": "",
