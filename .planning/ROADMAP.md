...
- [ ] 07-17-PLAN.md — MD-02: the display tree merges directories on the BYTE-IDENTICAL verbatim segment rather than on the truncated display label, so two 300-character sibling directories stay two nodes and no source file is shown as a sibling of a file it is not a sibling of (UI-05, MAP-04)
